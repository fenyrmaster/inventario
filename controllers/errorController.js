...
const handleJWTError = () => new CustomError("invalid token. dont try to log with that useless token", 401);
const handleJWTExpiredError = () => new CustomError("Invalid token. please log in again", 401);
